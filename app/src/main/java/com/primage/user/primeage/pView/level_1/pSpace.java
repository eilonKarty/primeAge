...
public class pSpace extends Space {

    public pSpace(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pSpace(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pSpace(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
...
/*
    @TargetApi(21)
    public pSpace(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws GUIConstraintException {
