...
public class pTextInputLayout extends TextInputLayout {

    public pTextInputLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pTextInputLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pTextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
