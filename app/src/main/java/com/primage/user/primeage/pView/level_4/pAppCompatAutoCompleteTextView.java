...
public class pAppCompatAutoCompleteTextView extends AppCompatAutoCompleteTextView {

    public pAppCompatAutoCompleteTextView(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pAppCompatAutoCompleteTextView(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pAppCompatAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
