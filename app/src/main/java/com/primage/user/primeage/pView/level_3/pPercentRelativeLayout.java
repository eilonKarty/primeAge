...
public class pPercentRelativeLayout extends PercentRelativeLayout {

    public pPercentRelativeLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pPercentRelativeLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pPercentRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
