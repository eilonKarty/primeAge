...
public class pZoomControls extends ZoomControls {

    public pZoomControls(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pZoomControls(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
