...
public class pTableRow extends TableRow {

    public pTableRow(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pTableRow(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
