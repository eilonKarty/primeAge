...
public class pTabLayout extends TabLayout {
    ...
    public pTabLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pTabLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pTabLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
