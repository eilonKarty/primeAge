...
public class pDrawerLayout extends DrawerLayout {
    ...
    public pDrawerLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pDrawerLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pDrawerLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
