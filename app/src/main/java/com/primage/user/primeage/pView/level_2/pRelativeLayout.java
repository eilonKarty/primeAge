...
public class pRelativeLayout extends RelativeLayout {
    ...
    public pRelativeLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pRelativeLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
    ...
    @TargetApi(21)
    public pRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws GUIConstraintException {
