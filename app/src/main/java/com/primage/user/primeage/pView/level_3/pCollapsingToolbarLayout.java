...
public class pCollapsingToolbarLayout extends CollapsingToolbarLayout {

    public pCollapsingToolbarLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pCollapsingToolbarLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pCollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
