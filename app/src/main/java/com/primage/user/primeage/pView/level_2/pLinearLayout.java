...
public class pLinearLayout extends LinearLayout {
    ...
    public pLinearLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pLinearLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
    ...
    @TargetApi(21)
    public pLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws GUIConstraintException {
