...
public class pFloatingActionButton extends FloatingActionButton {

    public pFloatingActionButton(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pFloatingActionButton(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pFloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
