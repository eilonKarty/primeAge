...
//ListRowHoverCardView is final- cannot inherit from final class

/*

public class pListRowHoverCardView extends ListRowHoverCardView {

    public pListRowHoverCardView(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pListRowHoverCardView(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pListRowHoverCardView(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
