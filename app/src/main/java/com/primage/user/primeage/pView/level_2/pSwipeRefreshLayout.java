...
public class pSwipeRefreshLayout extends SwipeRefreshLayout {
    ...
    public pSwipeRefreshLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pSwipeRefreshLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
