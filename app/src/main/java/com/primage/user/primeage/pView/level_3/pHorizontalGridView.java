...
public class pHorizontalGridView extends HorizontalGridView {

    public pHorizontalGridView(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pHorizontalGridView(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pHorizontalGridView(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
