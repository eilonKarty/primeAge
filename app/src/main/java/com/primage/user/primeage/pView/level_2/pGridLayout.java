...
public class pGridLayout extends GridLayout {
    ...
    public pGridLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pGridLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pGridLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
