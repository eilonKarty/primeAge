...
public class pFragmentTabHost extends FragmentTabHost {

    public pFragmentTabHost(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pFragmentTabHost(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
