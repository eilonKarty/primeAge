...
public class pSearchEditText extends SearchEditText {

    public pSearchEditText(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pSearchEditText(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pSearchEditText(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
