...
public class pMediaController extends MediaController {

    public pMediaController(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pMediaController(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
