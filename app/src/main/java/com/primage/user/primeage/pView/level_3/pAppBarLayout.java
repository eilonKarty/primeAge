...
public class pAppBarLayout extends AppBarLayout {

    public pAppBarLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pAppBarLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
