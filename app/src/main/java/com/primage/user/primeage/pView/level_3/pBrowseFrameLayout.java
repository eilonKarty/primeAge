...
public class pBrowseFrameLayout extends BrowseFrameLayout {

    public pBrowseFrameLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pBrowseFrameLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pBrowseFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
