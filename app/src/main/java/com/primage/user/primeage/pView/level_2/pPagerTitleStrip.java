...
public class pPagerTitleStrip extends PagerTitleStrip {

    public pPagerTitleStrip(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pPagerTitleStrip(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
