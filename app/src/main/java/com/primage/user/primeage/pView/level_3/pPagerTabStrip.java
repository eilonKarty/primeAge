...
public class pPagerTabStrip extends PagerTabStrip {

    public pPagerTabStrip(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pPagerTabStrip(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
