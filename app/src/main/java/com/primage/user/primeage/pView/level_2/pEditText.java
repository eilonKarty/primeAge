...
public class pEditText extends EditText {
    ...
    public pEditText(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pEditText(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pEditText(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
    ...
    @TargetApi(21)
    public pEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws GUIConstraintException {
