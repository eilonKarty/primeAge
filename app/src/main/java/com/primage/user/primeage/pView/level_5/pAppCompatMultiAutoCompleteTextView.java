...
public class pAppCompatMultiAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView {

    public pAppCompatMultiAutoCompleteTextView(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pAppCompatMultiAutoCompleteTextView(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pAppCompatMultiAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
