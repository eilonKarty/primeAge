...
//RowHeaderView is final class- cannot inherit

/*

public class pRowHeaderView extends RowHeaderView {

    public pRowHeaderView(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pRowHeaderView(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pRowHeaderView(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
