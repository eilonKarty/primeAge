...
//ListRowView is final- cannot inherit from final class

/*

public class pListRowView extends ListRowView {

    public pListRowView(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pListRowView(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pListRowView(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
