...
public class pViewSwitcher extends ViewSwitcher {

    public pViewSwitcher(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pViewSwitcher(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
