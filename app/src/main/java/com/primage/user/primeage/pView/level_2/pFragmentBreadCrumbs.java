...
public class pFragmentBreadCrumbs extends FragmentBreadCrumbs {

    public pFragmentBreadCrumbs(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pFragmentBreadCrumbs(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pFragmentBreadCrumbs(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
