...
public class pTextView extends TextView {
    ...
    public pTextView(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pTextView(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pTextView(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
    ...
    @TargetApi(21)
    public pTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws GUIConstraintException {
