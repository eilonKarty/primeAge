...
public class pLinearLayoutCompat extends LinearLayoutCompat {

    public pLinearLayoutCompat(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pLinearLayoutCompat(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pLinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
