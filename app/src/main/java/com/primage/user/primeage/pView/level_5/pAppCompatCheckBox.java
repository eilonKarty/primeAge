...
public class pAppCompatCheckBox extends AppCompatCheckBox {

    public pAppCompatCheckBox(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pAppCompatCheckBox(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pAppCompatCheckBox(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
