...
public class pShadowOverlayContainer extends ShadowOverlayContainer {

    public pShadowOverlayContainer(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pShadowOverlayContainer(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pShadowOverlayContainer(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
