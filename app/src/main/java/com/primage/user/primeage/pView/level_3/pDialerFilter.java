...
public class pDialerFilter extends DialerFilter {

    public pDialerFilter(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pDialerFilter(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
