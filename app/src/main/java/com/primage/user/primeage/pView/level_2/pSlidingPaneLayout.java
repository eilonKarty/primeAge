...
public class pSlidingPaneLayout extends SlidingPaneLayout {

    public pSlidingPaneLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pSlidingPaneLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pSlidingPaneLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
