...
public class pVideoView extends VideoView {
    ...
    public pVideoView(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pVideoView(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pVideoView(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
    ...
    @TargetApi(21)
    public pVideoView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws GUIConstraintException {
