...
public class pTableLayout extends TableLayout {

    public pTableLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pTableLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
