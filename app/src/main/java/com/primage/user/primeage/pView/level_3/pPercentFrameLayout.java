...
public class pPercentFrameLayout extends PercentFrameLayout {

    public pPercentFrameLayout(Context context) throws GUIConstraintException{
        super(context);
        checkConstraints(context);
    }


    public pPercentFrameLayout(Context context, AttributeSet attrs) throws GUIConstraintException{
        super(context, attrs);
        checkConstraints(context, attrs);
    }


    public pPercentFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) throws GUIConstraintException {
